...
import { Calendar, CheckCircle2, Clock, MapPin, ReceiptText, ShieldCheck, Users, XCircle } from 'lucide-react'
    ...
    return (
      <CustomerLayout title="Reservation" hidePageHeader>
        <div className="mx-auto w-full max-w-3xl px-4 py-12 text-center">
          ...
          <Button onClick={() => navigate('/app/reservations/my')} className="mt-4 rounded-full bg-neon-pink text-white hover:bg-neon-pink/90">
            My reservations
          </Button>
        </div>
      </CustomerLayout>
      ...
      <div className="mx-auto w-full max-w-6xl space-y-4 px-4 pb-32 pt-5 lg:px-8">
        ...
        <section className="grid gap-4 lg:grid-cols-[1fr_340px]">
          ...
          <aside className="h-fit rounded-3xl bg-white/[0.08] p-5 shadow-[0_18px_55px_rgba(0,0,0,0.22)]">
            ...
            <Button variant="ghost" onClick={() => navigate('/app/reservations/my')} className="mt-3 w-full rounded-full text-white/70 hover:bg-white/10 hover:text-white">
              My reservations
            </Button>
          </aside>
        </section>
