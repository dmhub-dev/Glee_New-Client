  ...
  return (
    <CustomerLayout title="Wallet" subtitle="Top up and pay for event tickets from your Glee wallet." hidePageHeader>
      ...
      <div className="grid min-w-0 gap-4 lg:grid-cols-[minmax(320px,420px)_1fr]">
        <section className="min-w-0 overflow-hidden rounded-3xl bg-white/[0.08] shadow-[0_18px_55px_rgba(0,0,0,0.22)]">
          ...
          <div className="bg-black/20 p-4 sm:p-5">
            ...
            <div className="grid gap-3">
              <Input
                ...
                className="h-11 rounded-full border-transparent bg-white/[0.08] text-white placeholder:text-white/35"
              />
        ...
        <section className="min-w-0 rounded-3xl bg-white/[0.08] p-4 shadow-[0_18px_55px_rgba(0,0,0,0.22)] sm:p-5">
          ...
          <div className="mt-5">
            {transactionsLoading ? (
              ...
              <div className="rounded-2xl bg-black/20 p-10 text-center">
                ...
                <div className="space-y-3">
                  {(transactions ?? []).map(tx => {
                    ...
                    return (
                      <article key={tx.id} className="min-w-0 rounded-2xl bg-black/20 p-3.5">
                        ...
                        <div className="mt-4 grid grid-cols-2 gap-3 text-xs">
                          ...
                          <div className="col-span-2 rounded-xl bg-white/[0.06] p-3">
